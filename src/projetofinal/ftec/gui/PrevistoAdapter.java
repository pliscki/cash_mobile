...
public class PrevistoAdapter extends CursorAdapter {
	private Context context;
	private LayoutInflater layoutInflater;
	
	public PrevistoAdapter(Context context, Cursor cursor) {
	...
	public void bindView(View v, Context ctx, Cursor c) {
		...
		tvDescricao.setText(c.getString(c.getColumnIndexOrThrow(Previstos.GET_DESCRICAO)));
		tvValor.setText(v.getContext().getString(R.string.sigla_moeda) + " " + 
					CustomDecimalUtils.format(c.getDouble(c.getColumnIndexOrThrow(Previstos.GET_VAL_PREVISTO))));
		tvContato.setText("");
		...
		try {
			datVencimento = CustomDateUtils.toCalendar(c.getString(c.getColumnIndexOrThrow(Previstos.GET_DT_VENCIMENTO)));
		...
		tvVencimento.setText(v.getContext().getString(R.string.vencimento) + ": " +
